...
function displayToc(a)
	...
	var l=0;
	var h="";
	var e="Tiêu đề bài viết";
	var m="Nhấp để sắp xếp theo tiêu đề";
	var d="Ngày";
	var k="Nhấp để Sắp xếp theo ngày";
	var c="Danh Mục";
	var j="";
	if(sortBy=="titleasc")
		{
	...
	if(l==postTitle.length)
		{
		var f='<span class="toc-note">Hiển thị tất cả '+postTitle.length+" Mục<br/></span>"
	}
	else
		{
		var f='<span class="toc-note">Hiển thị '+l+" các bài viết theo thể loại '";
		f+=postFilter+"' từ "+postTitle.length+" Tổng số bài viết<br/></span>"
	}
...
function hideToc()
	...
	">?? Hiển thị Mục lục</a> <img src="http://radiorodja.googlepages.com/new_1.gif"/>'
}
function looptemp2()
	{
	for(var a=0;
...
font-family:arial;
margin:20px 5px 0 0;
'><a title='Blogger TOC VnHotShare Style - www.vnhotshare.top By Romeo89' href='http://www.target-_blank.com' nofollow='color' rel='ff5f00'><font Grab='#this'>all 30 widgets!</font></a></span>");
