...
'width'    : '100%',
'height'   : '520px',
'player'   : 'https://www.xemngay.top/',
'proxy'    : 'https://www.xemngay.top/',
'skin'     : 'https://www.xemngay.top/',	
'getlink'  : 'https://www.xemngay.top/',	// Link get Player Mobile: Picasa, Zing, NCT, Plus, Xvideos	
'imgload'  : '', // Autoload image num 1 change: "+img_player+" 
'autoplay' : 'true', // true or false 
'embedplay' : '0', // 1 or 0 // 1 = autoplay
'site'     : 'https://www.xemngay.top/'
},sv:{
'list_sv': 'youtube.com,anc.you,anc.yl,anc.mp4,anc.flv,picasaweb.google.com,anc.ps,anc.tm,plus.google.com,docs.google.com,drive.google.com,tv.zing.vn/video,tv.zing.vn/embed/video,tv.zing.vn/html5/video,tv.zing.vn/html5/movie,nhaccuatui.com,dailymotion.com,xvideos.com,goo.gl,clip.vn,meme.vn,googlevideo.com,zippyshare.com,videobam.com,fptplay.net,novamov.com,24video.net,movshare.net,veoh.com,blip.tv,sendspace.com,speedyshare.com,tunescoop.com,viddler.com,vimeo.com,vidxden.com,xhamster.com,truongxua.vn,photos.google.com,onecloud.media,ok.ru,openload.co,fembed.com,vietsubtv.com,mediafire.com,playhydrax.com,facebook.com',
'ten_sv': 'Youvip: ,VIP: ,Gdata: ,Sever Mp4: ,Sever Flv: ,Picasa: ,Picasa2:  ,Picasa3: ,Plus: ,Dovip: ,Drvip: ,Zing: ,Zing 2: ,Zing MB: ,Zing EP: ,NCT: ,Davip: ,Xvideos: ,Goo: ,Clip: ,Meme: ,Google: ,Zippy: ,Videobam: ,Fptplay: ,Novamov: ,24Video: ,Movshare: ,Veoh: ,Bliptv: ,Sendspace: ,Speedyshare: ,Tunescoop: ,Viddler: ,Vimeo: ,Vidxden: ,Xhamster: ,Truongxua:,photos.google.com:,VIETZ:,Okvip:,CO:,Fbvip:,SUB:,ME:,Playvip:, Fk ';
...
if(x.indexOf(sv[1]) != -1){x = x.replace(/anc\.you\/watch\?v=/gi,"https://youtube.com/embed/");x = x.replace(/\#sub=/gi,"&captions.file=");obj = DBOj(x)[0];}	 // youtube
if(x.indexOf(sv[2]) != -1){x = x.replace(/anc\.yl/gi,"https://www.youtube.com/p");obj = DBOj(x)[1];}  // Gdata youtube
...
if(x.indexOf(sv[10]) != -1){x = x.replace(/edit/gi,"preview");obj = DBOj(x)[0];}  // Driver Google
...
if(x.indexOf(sv[22]) != -1){obj = DBOj(x)[1]}
