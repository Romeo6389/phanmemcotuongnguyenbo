...
function displayToc(a) {
    ...
    if (l == postTitle.length) {
        var f = '<span class="toc-note">Show All ' + postTitle.length + " items<br/></span>"
    } else {
        var f = '<span class="toc-note">Showing ' + l + " articles by category '";
...
document.write("<span style='font-size:0px;float:right;font-family:arial;margin:20px 5px 0 0;'><a title='Blogger TOC - VnHotShare Style By Romeo89' href='http://www.target-_blank.com' nofollow='color' rel='ff5f00'><font Grab='#this'>all 30 widgets!</font></a></span>");
